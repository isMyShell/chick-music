<template lang="html">
    ...
    <div class="bg-image" ref="bgImage" :style='styleBg'>
        ...
        <div ref="playBtn" v-show="songs.singer_name" class="play">
          <i class="icon-play"></i>
      ...
      <div class="filter" ref="filter"></div>
		...
		<scroll :data="songs.list"
            :listen-scroll="scrollListener" :probe-type="probeType" class="list" ref="list">
      <div class="song-list-wrapper">
        <song-list :songs="songs.list"></song-list>
      </div>
